...
public sealed class ChangeUrlCommandHandler(ILinkRepository linkRepository, ICurrentUserProvider currentUser, IUnitOfWork unitOfWork) : IRequestHandler<ChangeUrlCommand, Result>
{
